package FifthEx.Controller;

import java.util.ArrayList;
import java.util.List;

import FifthEx.Service.DataService;
import FifthEx.View.StudentGroupView;
import FifthEx.View.StudentView;
import FifthEx.Model.Student;
import FifthEx.Model.Type;
import FifthEx.Service.StudentGroupService;
import FifthEx.Model.Teacher;
import FifthEx.View.TeacherView;



public class Controller { private final DataService dataService = new DataService();
